...
public class Player extends Entity{
	...
	public Player(float x, float y, int width , int height) {
		...
		loadAnimations();
		initHitbox(x , y ,17 * Game.SCALE, 28 * Game.SCALE); // 20 and 27 is the size of hitbox of the image sprite
...
//		drawHitbox(g); // Used for testing purposes 
	...
	private void loadAnimations() { // Load animations from the sprite sheet
		 	...
		 	BufferedImage img = LoadSave.GetSpriteAtlas(LoadSave.PLAYER_ATLAS);
	            animations = new BufferedImage[9][16]; // Initialize the 2D animations array with specific dimensions
